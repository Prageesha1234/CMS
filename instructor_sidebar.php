    ...
    <nav>
        <ul>
            <li class="<?php echo basename($_SERVER['PHP_SELF']) === 'instructor_dashboard.php' ? 'active' : ''; ?>">
                <a href="instructor_dashboard.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
            </li>
            <li class="<?php echo basename($_SERVER['PHP_SELF']) === 'my_courses.php' ? 'active' : ''; ?>">
                <a href="my_course.php"><i class="fas fa-book"></i> My Courses</a>
            </li>
            <li class="<?php echo basename($_SERVER['PHP_SELF']) === 'upload_course.php' ? 'active' : ''; ?>">
                <a href="upload_course.php"><i class="fas fa-upload"></i> Upload Course</a>
            </li>
            <li class="<?php echo basename($_SERVER['PHP_SELF']) === 'assignments.php' ? 'active' : ''; ?>">
                <a href="assignment.php"><i class="fas fa-tasks"></i> Assignments</a>
            </li>
            <li class="<?php echo basename($_SERVER['PHP_SELF']) === 'questionnaires.php' ? 'active' : ''; ?>">
                <a href="questionnaire.php"><i class="fas fa-question-circle"></i> Questionnaires</a>
            </li>
            <li class="<?php echo basename($_SERVER['PHP_SELF']) === 'grades.php' ? 'active' : ''; ?>">
                <a href="grade.php"><i class="fas fa-graduation-cap"></i> Grade Assignments</a>
            </li>
            <li>
